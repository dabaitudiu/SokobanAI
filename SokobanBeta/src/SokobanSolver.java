...
//        search();
        ...
        for (int i = start; i < n+start; i++) {
            ...
            String outputFile = String.format("formal_inputs/input_10_10_2_%d.txt",i);
            MapGenerator generator = new MapGenerator(10,10,10,3,System.currentTimeMillis(),outputFile);
